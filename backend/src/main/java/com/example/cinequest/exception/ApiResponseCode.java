...
public enum ApiResponseCode {
    ...
    ACCOUNT_NOT_REGISTERED(2012, 404, "Account not registered: Please check the email or register for a new account."),
    VERIFY_ACCOUNT_FAIL(
            2013, 404, "Verification failed: The account may not be registered. Please check and try again."),
    ACCOUNT_ALREADY_VERIFIED(2014, 403, "Account already verified: Please log in to access your account."),
    USER_NOT_FOUND(2015, 404, "User not found: The user does not exist. Please check again or register a new account."),
    VERIFY_ACCOUNT_SUCCESS(
            2016, 200, "Verification success: Your account has been successfully verified. You can now log in."),
    ...
    EMAIL_ALREADY_REGISTERED(
            2019, 409, "The email address is already registered. Please log in or use a different email."),
    RESET_PASSWORD_SUCCESS(
            2020, 200, "Your password has been successfully updated. You can now log in with your new password."),
    ...
    MOVIE_ALREADY_EXISTS(3002, 409, "Movie already exists: The movie is already in your movies."),
    ...
    FAVORITE_MOVIE_NOT_FOUND(
            3006, 404, "Favorite movie not found: The favorite movie you are trying to access does not exist."),
    FAVORITE_MOVIE_ALREADY_EXISTS(3007, 409, "Favorite movie already exists: The movie is already in your favorites."),
    ...
    USER_DETAILS_UPDATE_SUCCESS(
            5002, 200, "Your details have been successfully updated. The changes are now reflected in your profile."),

    //
    UNCATEGORIZED(9999, 400, "Uncategorized error");
