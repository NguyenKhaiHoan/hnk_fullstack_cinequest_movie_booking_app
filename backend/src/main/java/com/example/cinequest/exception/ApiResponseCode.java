...
public enum ApiResponseCode {
    ...
    FAVORITE_MOVIE_NOT_FOUND(3001, 404, "Favorite movie not found: The movie you are trying to access does not exist."),
    FAVORITE_MOVIE_ALREADY_EXISTS(3002, 409, "Favorite movie already exists: The movie is already in your favorites."),
