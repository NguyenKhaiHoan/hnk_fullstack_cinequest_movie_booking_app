...
public class GlobalExceptionHandler {
    @ExceptionHandler(value = CineQuestApiException.class)
    public ResponseEntity<Response> handleCineQuestApiException(CineQuestApiException exception) {
        ...
        HttpStatus httpStatus =
                switch (exception.getApiResponseCode().getHttpStatusCode()) {
