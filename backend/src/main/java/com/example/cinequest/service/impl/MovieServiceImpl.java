...
// import com.example.cinequest.jwt.JwtAppUser;
...
//
//    @Override
//    public void addMovie(AddMovieRequest request, String operation, HttpServletRequest httpServletRequest) throws
// CineQuestApiException {
//
...
//
//    @Override
//    public List<MovieDTO> getMovies(MovieListRequest request, HttpServletRequest httpServletRequest) throws
// CineQuestApiException {
//
//        if (jwtAppUser.isNotAdmin(httpServletRequest)) {
//            throw new CineQuestApiException(false, ApiResponseCode.ADMIN_ONLY);
